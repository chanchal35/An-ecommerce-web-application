...
import { MY_ORDER_LIST_FAIL, MY_ORDER_LIST_REQUEST, MY_ORDER_LIST_SUCCESS, 
    ...
    ORDER_LIST_FAIL, ORDER_LIST_REQUEST, ORDER_LIST_SUCCESS, ORDER_PAY_FAIL, 
...
const createOrder = (order) => async (dispatch, getState) => {
  ...
  export { createOrder, listMyOrders, detailsOrder, listOrders, payOrder, deleteOrder }